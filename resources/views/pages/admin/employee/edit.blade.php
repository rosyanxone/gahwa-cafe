    ...
    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
        ...
        <div class="flex flex-col gap-10">
            <div
                ...
                <form class="space-y-5" id="employee" action="{{ route('employee.update', ['user' => $employee->id]) }}" method="POST">
                    @csrf
                    @if ($errors->any())
                    ...
                    <div id="name">
                        ...
                        <div class="flex">
                            <input
                                ...
                                name="name" type="text" value="{{ old('name') ?? $employee->name }}" placeholder="John Doe"
                                required />
                        </div>
                    </div>
                    <div id="email">
                        ...
                        <div class="flex">
                            <input
                                class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                                name="email" type="text" value="{{ old('email') ?? $employee->email }}"
                    ...
                    <div id="phone-number">
                        ...
                        <div class="flex">
                            <input
                                class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                                name="phone_number" type="text" value="{{ old('phone_number') ?? $employee->phone_number }}"
                    ...
                    <div class="flex gap-2">
                        <div class="w-full" id="age">
                            ...
                            <div class="flex">
                                <input
                                    class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                                    name="age" type="number" value="{{ old('age') ?? $employee->age }}" min="1"
                    ...
                    <div class="flex gap-2">
                            ...
                            <div class="w-full" id="position">
                                ...
                                <div class="flex">
                                    <input
                                        ...
                                        value="{{ old('position') ?? $employee->position }}" placeholder="Karyawan" required />
                                </div>
                            </div>
                            <div class="w-full" id="religion">
                                ...
                                <div class="flex">
                                    <select
                                        ...
                                        <option value="Islam" @selected(old('religion') ?? $employee->religion == 'Islam')>Islam</option>
                                        <option value="Kristen" @selected(old('religion') ?? $employee->religion == 'Kristen')>Kristen</option>
                                        <option value="Katolik" @selected(old('religion') ?? $employee->religion == 'Katolik')>Katolik</option>
                                        <option value="Hindu" @selected(old('religion') ?? $employee->religion == 'Hindu')>Hindu</option>
                                        <option value="Budha" @selected(old('religion') ?? $employee->religion == 'Budha')>Budha</option>
                                        <option value="Konghucu" @selected(old('religion') ?? $employee->religion == 'Konghucu')>Konghucu</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        <div class="w-full" id="address">
                            ...
                            <textarea
                                class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                                name="address" rows="5" placeholder="Samarinda">{{ old('address') ?? $employee->address }}</textarea>
                        </div>
                    </div>
                    <div id="password">
                        <label class="mb-3 flex justify-between text-sm font-medium text-black dark:text-white">
