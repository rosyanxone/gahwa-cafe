    ...
    <div class="flex flex-grow items-center justify-between px-4 py-4 shadow-2 md:px-6 2xl:px-11">
        <div class="flex items-center gap-2 sm:gap-4 lg:hidden">
            ...
            <a class="block flex-shrink-0 lg:hidden" href="{{ route('dashboard') }}">
                <img class="h-11 w-11 rounded-full hover:shadow-lg" src="{{ asset('./img/logo/logo.jpg') }}"
                    alt="Logo" />
            </a>
        </div>
            ...
            <div class="relative">
                <div class="flex items-center gap-4">
                    <span class="hidden text-right lg:block">
                        ...
                        <span class="block text-xs font-medium">{{ auth()->user()->position }}</span>
                    </span>

                    <span class="h-11 w-11 overflow-hidden rounded-full">
                        <img src="{{ asset('./img/user/user.jpg') }}" alt="User" />
                    </span>
                </div>
            </div>
            <!-- User Area -->
