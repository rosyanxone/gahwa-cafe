<aside
    ...
    <div class="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        ...
        <div
            ...
            <a class="flex items-center justify-center rounded-md bg-primary p-2 text-white hover:bg-opacity-95"
                href="https://tailadmin.com/pricing" target="_blank" rel="nofollow">
                Purchase Now
            </a>
        </div>
        <!-- Promo Box -->
