<aside
    ...
    <div class="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        <!-- Sidebar Menu -->
        <nav class="mt-5 px-4 py-4 lg:px-6" x-data="{ selected: $persist('Dashboard') }">
            <!-- Menu Group -->
            <div>
                ...
                <ul class="mb-6 flex flex-col gap-1.5">
                    ...
                    @if (auth()->user()->hasRole('admin'))
                        <!-- Menu Item Karyawan -->
                        <li>
                            <a class="{{ request()->segment(1) === 'employee' ? 'bg-graydark dark:bg-meta-4 pointer-events-none' : '' }} group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                    ...
                    <li>
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button
                                class="group relative flex w-full cursor-pointer items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4"
                                type="submit">
